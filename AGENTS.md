...
- Core-generated ResearchTask plans must be Chinese-first and editable before start. Plans should expose research questions, source strategy, quality gates, deliverables, and an explicit user-confirmation step rather than only a minimal step list.
