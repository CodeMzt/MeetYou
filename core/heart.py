    ...
    async def _create_scheduled_operation(self, task_record: dict[str, Any], *, operation_type: str, title: str):
        ...
        operation = self._core_services.operation.create_operation(
            ...
            metadata={
                ...
                "preferred_target_client_ids": list(task_record.get("preferred_target_client_ids") or []),
                "preferred_target_client_types": list(task_record.get("preferred_target_client_types") or []),
