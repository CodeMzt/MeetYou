...
_REMOVED_WECHAT_CONFIG_KEYS = {
    ...
    *{
        ...
        for suffix in (
            ...
            "send_timeout_ms",
            "state_flush_interval_ms",
            "gateway_endpoint_idle_ttl_seconds",
...
_ENV_KEY_MAP = {
    ...
    "clawbot_ilink_bot_token": "MEETYOU_CLAWBOT_ILINK_BOT_TOKEN",
...
_ENV_OVERRIDE_KEY_MAP = {
    ...
    "enable_clawbot_wechat_client": "MEETYOU_CLAWBOT_WECHAT_ENABLE",
    "clawbot_ilink_base_url": "MEETYOU_CLAWBOT_ILINK_BASE_URL",
    "clawbot_ilink_state_file": "MEETYOU_CLAWBOT_ILINK_STATE_FILE",
    "clawbot_ilink_bot_id": "MEETYOU_CLAWBOT_ILINK_BOT_ID",
    "clawbot_ilink_user_id": "MEETYOU_CLAWBOT_ILINK_USER_ID",
    "clawbot_ilink_channel_version": "MEETYOU_CLAWBOT_ILINK_CHANNEL_VERSION",
    "clawbot_ilink_app_client_version": "MEETYOU_CLAWBOT_ILINK_APP_CLIENT_VERSION",
    "clawbot_ilink_route_tag": "MEETYOU_CLAWBOT_ILINK_ROUTE_TAG",
    "clawbot_ilink_poll_timeout_ms": "MEETYOU_CLAWBOT_ILINK_POLL_TIMEOUT_MS",
    "clawbot_ilink_max_text_chars": "MEETYOU_CLAWBOT_ILINK_MAX_TEXT_CHARS",
    "clawbot_ilink_inbound_worker_count": "MEETYOU_CLAWBOT_ILINK_INBOUND_WORKERS",
    "clawbot_ilink_inbound_queue_size": "MEETYOU_CLAWBOT_ILINK_INBOUND_QUEUE_SIZE",
    "clawbot_ilink_outbound_min_interval_ms": "MEETYOU_CLAWBOT_ILINK_OUTBOUND_MIN_INTERVAL_MS",
    "clawbot_ilink_send_timeout_ms": "MEETYOU_CLAWBOT_ILINK_SEND_TIMEOUT_MS",
    "clawbot_ilink_state_flush_interval_ms": "MEETYOU_CLAWBOT_ILINK_STATE_FLUSH_INTERVAL_MS",
    "clawbot_ilink_gateway_endpoint_idle_ttl_seconds": "MEETYOU_CLAWBOT_ILINK_GATEWAY_ENDPOINT_IDLE_TTL_SECONDS",
    "clawbot_ilink_reply_timeout_seconds": "MEETYOU_CLAWBOT_ILINK_REPLY_TIMEOUT_SECONDS",
