...
_ENV_OVERRIDE_KEY_MAP = {
    ...
    "clawbot_wechat_state_dir": "MEETYOU_CLAWBOT_WECHAT_STATE_DIR",
    "clawbot_wechat_base_url": "MEETYOU_CLAWBOT_WECHAT_BASE_URL",
    "clawbot_wechat_state_file": "MEETYOU_CLAWBOT_WECHAT_STATE_FILE",
    "clawbot_wechat_poll_timeout_ms": "MEETYOU_CLAWBOT_WECHAT_POLL_TIMEOUT_MS",
    "clawbot_wechat_max_text_chars": "MEETYOU_CLAWBOT_WECHAT_MAX_TEXT_CHARS",
    "clawbot_wechat_bot_agent": "MEETYOU_CLAWBOT_WECHAT_BOT_AGENT",
    "clawbot_wechat_channel_version": "MEETYOU_CLAWBOT_WECHAT_CHANNEL_VERSION",
    "clawbot_wechat_ilink_app_id": "MEETYOU_CLAWBOT_WECHAT_ILINK_APP_ID",
    "clawbot_wechat_ilink_app_client_version": "MEETYOU_CLAWBOT_WECHAT_ILINK_APP_CLIENT_VERSION",
    "clawbot_wechat_inbound_worker_count": "MEETYOU_CLAWBOT_WECHAT_INBOUND_WORKERS",
    "clawbot_wechat_inbound_queue_size": "MEETYOU_CLAWBOT_WECHAT_INBOUND_QUEUE_SIZE",
    "clawbot_wechat_outbound_min_interval_ms": "MEETYOU_CLAWBOT_WECHAT_OUTBOUND_MIN_INTERVAL_MS",
    "clawbot_wechat_send_timeout_ms": "MEETYOU_CLAWBOT_WECHAT_SEND_TIMEOUT_MS",
    "clawbot_wechat_state_flush_interval_ms": "MEETYOU_CLAWBOT_WECHAT_STATE_FLUSH_INTERVAL_MS",
    "clawbot_wechat_gateway_endpoint_idle_ttl_seconds": "MEETYOU_CLAWBOT_WECHAT_GATEWAY_ENDPOINT_IDLE_TTL_SECONDS",
    "clawbot_wechat_reply_timeout_seconds": "MEETYOU_CLAWBOT_WECHAT_REPLY_TIMEOUT_SECONDS",
