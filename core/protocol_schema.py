...
CONFIG_FIELD_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "meetwechat_inbound_worker_count": {
        "title": "MeetWeChat inbound workers",
        "description": "Concurrent inbound workers. Each chat remains ordered. Default 4.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "meetwechat_inbound_queue_size": {
        "title": "MeetWeChat inbound queue size",
        "description": "Backpressure queue size for /v1/events batches. Default 500.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "meetwechat_outbound_worker_count": {
        "title": "MeetWeChat outbound workers",
    ...
    "meetwechat_outbound_queue_size": {
        "title": "MeetWeChat outbound queue size",
        "description": "Queue size for /v1/messages/text tasks. Default 500.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "meetwechat_outbound_min_interval_ms": {
        "title": "MeetWeChat send interval",
        "description": "Minimum interval between /v1/messages/text calls. Default 250 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "meetwechat_send_timeout_ms": {
        "title": "MeetWeChat send timeout",
        "description": "Timeout for a single /v1/messages/text call. Default 10000 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "meetwechat_state_flush_interval_ms": {
        "title": "MeetWeChat state flush interval",
        "description": "Debounce window for event, ACK, thread, and alias state writes. Default 500 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "meetwechat_gateway_client_idle_ttl_seconds": {
        "title": "MeetWeChat client idle TTL",
