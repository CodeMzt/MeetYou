...
CONFIG_FIELD_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "enable_clawbot_wechat_client": {
        ...
        "description": "Use the official Tencent ClawBot/OpenClaw WeChat channel as the main WeChat Endpoint Provider.",
        "group": "advanced",
        "input": "boolean",
        "advanced": True,
    },
    "clawbot_wechat_state_dir": {
        "title": "ClawBot OpenClaw state directory",
        "description": "Directory that contains openclaw-weixin/accounts.json and account token files. Defaults to OPENCLAW_STATE_DIR or ~/.openclaw.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    ...
    "clawbot_wechat_base_url": {
        "title": "ClawBot iLink API base URL",
        "description": "Optional override for the official iLink API base URL. Leave empty to use the baseUrl stored by OpenClaw login.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    ...
    "clawbot_wechat_state_file": {
        "title": "ClawBot WeChat MeetYou state file",
        "description": "Stores getupdates cursors, context tokens, dedupe state, and Core thread bindings. Do not commit it.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "user/clawbot_wechat_state.json",
        "examples": ["user/clawbot_wechat_state.json"],
    },
    "clawbot_wechat_poll_timeout_ms": {
        "title": "ClawBot getupdates timeout",
    ...
    "clawbot_wechat_max_text_chars": {
        "title": "ClawBot text fragment size",
    ...
    "clawbot_wechat_bot_agent": {
        "title": "ClawBot bot agent",
        "description": "bot_agent value sent in official iLink base_info.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "MeetYou/1.0",
    },
    "clawbot_wechat_channel_version": {
        "title": "ClawBot channel version",
        "description": "channel_version value sent in official iLink base_info.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "meetyou",
    ...
    "clawbot_wechat_ilink_app_id": {
        "title": "ClawBot iLink app id",
        "description": "Optional iLink-App-Id header value.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    },
    "clawbot_wechat_ilink_app_client_version": {
        ...
        "description": "Optional iLink-App-ClientVersion header value. Default 0.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    },
    "clawbot_wechat_inbound_worker_count": {
        "title": "ClawBot inbound workers",
    ...
    "clawbot_wechat_inbound_queue_size": {
        "title": "ClawBot inbound queue size",
    ...
    "clawbot_wechat_state_flush_interval_ms": {
        "title": "ClawBot state flush interval",
    ...
    "clawbot_wechat_gateway_endpoint_idle_ttl_seconds": {
        "title": "ClawBot endpoint idle TTL",
