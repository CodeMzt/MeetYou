...
CONFIG_FIELD_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "enable_clawbot_wechat_client": {
        "title": "Enable ClawBot WeChat endpoint provider",
        "description": "Use MeetYou's native ClawBot iLink HTTP provider. It does not require a third-party runtime or CLI.",
        "group": "advanced",
        "input": "boolean",
        "advanced": True,
    },
    "clawbot_ilink_base_url": {
        "title": "ClawBot iLink base URL",
        "description": "iLink API base URL. QR login may update this to the baseurl returned by Tencent.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "https://ilinkai.weixin.qq.com",
        "examples": ["https://ilinkai.weixin.qq.com"],
    },
    "clawbot_ilink_state_file": {
        "title": "ClawBot iLink state file",
        "description": "Stores getupdates cursors, context tokens, dedupe state, and Core thread bindings. Do not commit it.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "user/clawbot_ilink_state.json",
        "examples": ["user/clawbot_ilink_state.json"],
    },
    "clawbot_ilink_bot_token": {
        "title": "ClawBot iLink bot token",
        "description": "Secret Bearer token returned by QR login. Stored in .env.",
        "group": "advanced",
        "input": "password",
        "advanced": True,
    },
    "clawbot_ilink_bot_id": {
        "title": "ClawBot iLink bot id",
        "description": "Bot id returned by QR login.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    },
    "clawbot_ilink_user_id": {
        "title": "ClawBot iLink user id",
        "description": "Logged-in bot user id returned by QR login when available.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    },
    "clawbot_ilink_channel_version": {
        "title": "ClawBot iLink channel version",
        "description": "channel_version sent in iLink base_info. Default 2.0.0.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "2.0.0",
    ...
    "clawbot_ilink_app_client_version": {
        "title": "ClawBot iLink app client version",
        "description": "iLink-App-ClientVersion header value. Default 1.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "1",
    ...
    "clawbot_ilink_route_tag": {
        "title": "ClawBot iLink route tag",
        "description": "Optional SKRouteTag header value for deployments that require routing tags.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    },
    "clawbot_ilink_poll_timeout_ms": {
        "title": "ClawBot iLink getupdates timeout",
        "description": "Long-poll timeout in milliseconds for ilink/bot/getupdates. Default 35000.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_max_text_chars": {
        "title": "ClawBot iLink text fragment size",
        "description": "Maximum characters per outgoing text fragment. Default 1800.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_inbound_worker_count": {
        "title": "ClawBot iLink inbound workers",
        "description": "Concurrent inbound workers. Same conversation remains ordered. Default 4.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_inbound_queue_size": {
        "title": "ClawBot iLink inbound queue size",
        "description": "Inbound backpressure queue size. Default 500.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_outbound_min_interval_ms": {
        "title": "ClawBot iLink send interval",
        "description": "Minimum interval between sendmessage calls. Default 250 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_send_timeout_ms": {
        "title": "ClawBot iLink send timeout",
        "description": "Single sendmessage request timeout in milliseconds. Default 15000.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_state_flush_interval_ms": {
        "title": "ClawBot iLink state flush interval",
        "description": "Debounce window for state persistence. Default 500 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_gateway_endpoint_idle_ttl_seconds": {
        "title": "ClawBot iLink endpoint idle TTL",
        "description": "Close idle cached endpoint sessions after this many seconds. Default 600.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "clawbot_ilink_reply_timeout_seconds": {
        "title": "ClawBot iLink reply timeout",
        "description": "How long the provider waits for a Core assistant reply before leaving the event submitted. Default 120.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "enable_meetwechat_client": {
        ...
        "description": "Legacy/failed WeChat path kept only for history. New work should use enable_clawbot_wechat_client.",
        "group": "advanced",
        "input": "boolean",
        "advanced": True,
    },
    ...
    "core_shell_exec_enabled": {
        "title": "Core Shell Execution",
        "description": "Enable the Core-host command tool exec_core_cmd.",
        "group": "advanced",
        "input": "boolean",
        "advanced": True,
        "help_text": "When enabled, exec_core_cmd can run whitelisted commands on the Core Service host. It does not run on the Desktop Endpoint Provider.",
    },
    "core_cmd_policy_path": {
        "title": "Core Command Policy Path",
        "description": "JSON command allowlist policy used by exec_core_cmd.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "help_text": "Missing or invalid files fall back to the built-in Core whitelist, not unrestricted execution.",
        "examples": ["user/core_cmd_policy.json"],
    },
    "core_command_timeout_seconds": {
        "title": "Core Command Timeout",
        "description": "Maximum seconds allowed for exec_core_cmd.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "core_command_output_max_chars": {
        "title": "Core Command Output Limit",
        "description": "Maximum stdout or stderr characters returned by exec_core_cmd.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
