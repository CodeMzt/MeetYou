...
CONFIG_FIELD_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "enable_wechat_bot": {
        "title": "启用微信 iLink Bot",
        "description": "启用官方 iLink 二维码登录、长轮询输入与 sendmessage 输出适配器。",
        "group": "advanced",
        "input": "boolean",
        "advanced": True,
    },
    "wechat_ilink_base_url": {
        "title": "微信 iLink API 地址",
        "description": "官方 iLink API 基础地址。默认使用 https://ilinkai.weixin.qq.com；登录成功后优先使用返回的 baseurl。",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    ...
    "wechat_ilink_channel_version": {
        "title": "微信 iLink Channel 版本",
        "description": "iLink 业务请求 base_info.channel_version，默认跟随当前官方插件线 2.1.7。",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "2.1.7",
    ...
    "wechat_ilink_token_file": {
        "title": "微信 iLink 状态文件",
        "description": "保存 bot_token、get_updates_buf 与 context_token 的本地状态文件；不要提交到 Git。",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "user/wechat_ilink_state.json",
    },
    "wechat_ilink_qr_output_path": {
        "title": "微信 iLink 登录二维码路径",
        "description": "扫码登录二维码或二维码文本信息的输出路径，供管理员扫码/复制使用。",
        "group": "advanced",
        "input": "text",
        "advanced": True,
        "placeholder": "user/wechat-ilink-login-qr.png",
    },
    "wechat_ilink_poll_timeout_ms": {
        "title": "微信 iLink 长轮询超时",
        "description": "getupdates 长轮询请求超时，单位毫秒；默认 35000。",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_login_poll_interval_seconds": {
        "title": "微信 iLink 登录轮询间隔",
        "description": "二维码扫码状态轮询间隔，单位秒；默认 3。",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_max_text_chars": {
        "title": "微信 iLink 文本分片长度",
        "description": "sendmessage 文本分片最大字符数，默认 2000。",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "max_parallel_tool_calls": {
        ...
        "description": "Small-concurrency limit for safe read-only tool calls. Default 3.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "web_search_quality": {
        ...
        "description": "adaptive, fast, balanced, or deep. Default adaptive.",
        "group": "advanced",
        "input": "text",
        "advanced": True,
    ...
    "web_search_parallel_reads": {
        "title": "Web search parallel reads",
        "description": "Concurrent source extraction limit for search_web. Default 3.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "web_search_extract_timeout_seconds": {
        "title": "Web extract timeout",
        "description": "Timeout for Tavily extract calls inside web search. Default 6 seconds.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "memory_auto_search_timeout_ms": {
        "title": "Auto memory search timeout",
        "description": "Maximum wait for automatic memory prefetch. Default 1200 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "memory_background_episode_save": {
        "title": "Background memory save",
        "description": "Save automatic user-turn episodes outside the answer critical path.",
        "group": "advanced",
        "input": "boolean",
        "advanced": True,
    },
    "wechat_ilink_inbound_worker_count": {
        "title": "WeChat inbound workers",
        "description": "Concurrent inbound workers; same user remains ordered. Default 4.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_inbound_queue_size": {
        "title": "WeChat inbound queue size",
        "description": "Backpressure queue size for getupdates batches. Default 500.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_outbound_worker_count": {
        "title": "WeChat outbound workers",
        "description": "Concurrent outbound send workers. Default 2.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_outbound_queue_size": {
        "title": "WeChat outbound queue size",
        "description": "Queue size for iLink sendmessage tasks. Default 500.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_outbound_min_interval_ms": {
        "title": "WeChat send interval",
        "description": "Minimum interval between iLink sendmessage calls. Default 250 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_send_timeout_ms": {
        "title": "WeChat send timeout",
        "description": "Timeout for a single iLink sendmessage call. Default 10000 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_state_flush_interval_ms": {
        "title": "WeChat state flush interval",
        "description": "Debounce window for cursor/context/dedupe state writes. Default 500 ms.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
    "wechat_ilink_gateway_client_idle_ttl_seconds": {
        "title": "WeChat client idle TTL",
        "description": "Close idle cached GatewayConversationClient instances after this many seconds. Default 600.",
        "group": "advanced",
        "input": "number",
        "advanced": True,
    },
