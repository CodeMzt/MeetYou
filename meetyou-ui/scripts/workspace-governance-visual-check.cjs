...
const topologyPayload = {
  ...
  endpoints: [
    ...
    },
    {
      ...
      display_name: 'Feishu Cloud Bridge',
      endpoint_type: 'feishu_provider',
      ...
      provider_declared_workspace_ids: ['personal'],
      capability_count: 2,
      executable_tools: ['delivery.message', 'delivery.notice'],
      labels: ['input', 'output'],
      last_seen_at: '2026-05-05T00:00:00Z',
      core_owned: false,
    ...
    {
      endpoint_id: 'meetwechat.default.provider',
      display_name: 'MeetWeChat Bridge',
      endpoint_type: 'meetwechat_provider',
      provider_type: 'meetwechat',
      transport_type: 'websocket',
      status: 'online',
      connected: true,
      connection_count: 1,
  ...
  addresses: [
    ...
    {
      address_id: 'addr.feishu.cloud.ops-chat',
      endpoint_id: 'feishu.cloud.provider',
      display_name: 'Feishu Core Feedback',
      provider_type: 'feishu',
      address_type: 'group',
      status: 'sendable',
      workspace_ids: ['personal'],
      primary_workspace_id: 'personal',
      capabilities: ['delivery.message'],
      memberships: [{ workspace_id: 'personal', primary: true, role: 'member', enabled: true, source: 'core' }],
    },
    {
      address_id: 'addr.feishu.cloud.self',
      endpoint_id: 'feishu.cloud.provider',
      display_name: 'Feishu Direct',
      provider_type: 'feishu',
      address_type: 'direct',
      status: 'sendable',
      workspace_ids: ['personal'],
    ...
    {
      address_id: 'addr.meetwechat.team',
      endpoint_id: 'meetwechat.default.provider',
      display_name: '微信团队',
      provider_type: 'meetwechat',
      address_type: 'group',
    ...
    {
      address_id: 'addr.meetwechat.assistant',
      endpoint_id: 'meetwechat.default.provider',
      display_name: '控制助手',
      provider_type: 'meetwechat',
      address_type: 'direct',
    ...
    {
      address_id: 'addr.meetwechat.tencent',
      endpoint_id: 'meetwechat.default.provider',
      display_name: 'Tencent Notification',
      provider_type: 'meetwechat',
