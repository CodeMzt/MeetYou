...
3. `design/deployment-and-platform.md`
4. `operations/core-deployment.md`
5. `design/bot-integration.md`
6. `plan/implementation-plan.md`

## 文档分工

- `design/architecture-baseline.md`：当前仓库已经证实的运行边界与 V3 设计基线
- `design/desktop-unified-agent.md`：桌面端 UI + backend 一体化、local bridge 与运行边界设计
- `design/deployment-and-platform.md`：部署简化、容器化、跨平台与打包方向
- `operations/core-deployment.md`：Core 的 Docker Compose 与 Linux `systemd` 部署基线
- `operations/desktop-unified-acceptance.md`：桌面端一体化主链的人工启动与验收口径
- `design/bot-integration.md`：QQBot / WeChatBot 接入的设计边界与落点
