...
def build_static_capabilities(config: DesktopAgentConfig, *, extra_capabilities: list[dict[str, Any]] | None = None) -> list[dict[str, Any]]:
    ...
    base = [
        ...
        },
        {
            ...
            "description": "Runs on the Desktop Agent machine and analyzes directories from that local filesystem.",
        ...
        },
        {
            ...
            "description": "Runs on the Desktop Agent machine and reads files from that local filesystem.",
        ...
        },
        {
            ...
            "description": "Runs on the Desktop Agent machine and writes only within the agent trusted write roots.",
        ...
        },
        {
            ...
            "description": "Runs on the Desktop Agent machine using the agent command policy.",
